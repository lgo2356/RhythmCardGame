...
{
    public class UI_StageSelectPopupButton : UI_Button
    {
        ...
        public override void OnPointerClick(PointerEventData eventData)
        {
            ...
            if (StageSelectPopup.gameObject.activeSelf)
            {
        ...
        protected override void Start()
        {
            ...
            StageSelectPopup?.SetOnShowListener(OnCharacterPopupShow);
            StageSelectPopup?.SetOnHideListener(OnCharacterPopupHide);
        }
    }
}
